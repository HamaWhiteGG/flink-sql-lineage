...
public class CatalogTest {
    ...
    private void checkQueryCatalogInfo(String catalogName) throws Exception {
        ...
        assertEquals(Collections.singletonList(database), context.listDatabases(catalogName));
        assertEquals(Collections.singletonList(tableName), context.listTables(catalogName, database));
